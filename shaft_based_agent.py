...
class ShaftBased(AgentBase):
    """
    This is a model of an Agent class based on sillysoft's Quo agent
    """
...
if __name__ == "__main__":
    ...
    while True:
        if agent.state == 'waiting':
            ...
            print('Nobody can beat me')
        elif agent.state == 'loser':
            print('What, how is that possible?')
        else:
            print('State unknown')
...
attack:
    se player.ownsAnyContinent:
        ownedContinent = player.mostValuableContinent
